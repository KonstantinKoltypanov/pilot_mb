...
import type {
  PersonCardResponse,
  AdditionalPropertyNode,
} from "../../../../api/usePersonResource/interfaces";
...
const filterRowsByValue = (
  rows: AdditionalParamsRow[],
): AdditionalParamsRow[] => {
  return rows
    .map((row) => {
      if (row.children) {
...
export const AdditionalParams: React.FC<AdditionalParamsProps> = ({
  data,
  references,
}) => {
